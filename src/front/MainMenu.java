...
public class MainMenu {
	...
	private void initialize() {
		frame = new JFrame();
		frame.setTitle("典型操作系统算法可视化软件");
		frame.setBackground(Color.WHITE);
		frame.setBounds(100, 100, 400, 560);
		frame.setLocationRelativeTo(null);
		frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		comboBox_page = new JComboBox(GlobalOptions.pageReplacements);
		comboBox_page.setBackground(Color.WHITE);
		comboBox_page.setFont(new Font("宋体", Font.PLAIN, 12));
		comboBox_memory = new JComboBox(GlobalOptions.memoryComparators);
		...
		comboBox_block = new JComboBox(GlobalOptions.processComparators);
		comboBox_block.setBackground(Color.WHITE);
		comboBox_block.setFont(new Font("宋体", Font.PLAIN, 12));
		comboBox_ready = new JComboBox(GlobalOptions.processComparators);
		...
		startos.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				GlobalOptions.block_comparator=(Comparator<Process_>) comboBox_block.getSelectedItem();
				GlobalOptions.ready_comparator=(Comparator<Process_>) comboBox_ready.getSelectedItem();
				GlobalOptions.pageReplacement=(PageReplacementInterface) comboBox_page.getSelectedItem();
				GlobalOptions.memory_comparator=(Comparator<Memory_>) comboBox_memory.getSelectedItem();
				if(checkBox_vir.isSelected()){
					MemoryController.initialize(Integer.parseInt(textField_sum.getText()), Integer.parseInt(textField_defaultpage.getText()));
				}
				else MemoryController.initialize(Integer.parseInt(textField_sum.getText()));
				new ProcessController(Integer.parseInt(textField_degree.getText().toString()),Integer.parseInt(textField_batch.getText().toString()));
		...
		JButton exitos = new JButton("退出");
		exitos.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				exitos();
			}
		});
		exitos.setFont(new Font("宋体", Font.PLAIN, 12));
		exitos.setBackground(SystemColor.menu);
			...
			groupLayout.createParallelGroup(Alignment.LEADING)
				.addGroup(groupLayout.createSequentialGroup()
					...
					.addGroup(groupLayout.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(groupLayout.createSequentialGroup()
							.addComponent(startos, GroupLayout.PREFERRED_SIZE, 109, GroupLayout.PREFERRED_SIZE)
							.addGap(42)
							.addComponent(exitos, GroupLayout.PREFERRED_SIZE, 109, GroupLayout.PREFERRED_SIZE)))
			...
			groupLayout.createParallelGroup(Alignment.LEADING)
				.addGroup(groupLayout.createSequentialGroup()
					...
					.addGroup(groupLayout.createParallelGroup(Alignment.BASELINE)
						...
						.addComponent(exitos, GroupLayout.PREFERRED_SIZE, 60, GroupLayout.PREFERRED_SIZE))
